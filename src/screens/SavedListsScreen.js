...
const cS = StyleSheet.create({
  ...
  chipQty: { fontSize: 10 },
  chipMoreText: { fontSize: 11, fontWeight: '700' },
...
function makeStyles(c, isDark) {
  return StyleSheet.create({
    ...
    joinBtn: {
      ...
      borderRadius: 12, borderWidth: 1.5, borderColor: isDark ? c.border : '#E0DCFF',
    },
    joinBtnText: { color: c.primary, fontWeight: '700', fontSize: 13 },
    ...
    emptyTitle: { fontSize: 19, fontWeight: '800', color: c.text, marginBottom: 8, marginTop: 16, textAlign: 'center' },
